...
/*
Write unit tests for the program and
get as close to 100% code coverage as you can. If you find any bugs, fix them.
*/
...
func parser(data []byte) (Input, error) {
	...
	if len(lines) < 4 {
		return Input{}, fmt.Errorf("not enough lines: got %d, want 4", len(lines))
	}
